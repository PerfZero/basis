      ...
      <div className={s.card}>
        ...
        <div className={s.body}>
          <div className={s.left}>
            ...
            {tab?.buttonLabel && (
              <a href={tab.buttonHref ?? "#"} className={s.btn}>
                {tab.buttonLabel}
